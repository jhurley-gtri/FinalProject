...
public:
	...
	void CreateFromData(uint8_t * bData, int a_iWidth, int a_iHeight, int a_iBPP, GLenum format, bool bGenerateMipMaps = false);
...
private:
	...
	uint32_t uiTexture; // Texture name
	uint32_t uiSampler; // Sampler name
